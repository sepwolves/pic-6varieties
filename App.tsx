...
const App: React.FC = () => {
  ...
  // Initialize results state with empty placeholders mapped to styles
  ...
  const handleImageSelect = async (base64: string) => {
    ...
    // Trigger generation for all styles
    // We do this in parallel, but independent of each other so UI updates as they finish
    ...
    <div className="min-h-screen bg-gray-950 text-gray-100 selection:bg-purple-500 selection:text-white">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white via-purple-200 to-purple-400 mb-6 tracking-tight">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-start justify-center">
            ...
            {sourceImage && (
               <div className="w-full md:w-48 shrink-0 mx-auto md:mx-0 animate-in fade-in zoom-in duration-500">
        ...
        <div className="mt-24 border-t border-gray-900 pt-8 text-center text-gray-600 text-sm">
          ...
          <p className="mt-2">&copy; {new Date().getFullYear()} AI Portrait Studio</p>
        </div>
      </main>
    </div>
  );
